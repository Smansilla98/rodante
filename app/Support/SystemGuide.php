    ...
    public static function roles(): array
    {
        return [
            [
                ...
                'summary' => 'Acceso de solo lectura. Destinado a gerencia, auditoría o perfiles que requieren consultar el estado de la flota sin registrar operaciones.',
                'day' => 'Consulta el tablero, planillas, fichas de cubiertas, stock, compras e informes. No confirma operaciones ni modifica el mapa de posiciones.',
                'can' => [
                    'Consultar tablero, unidades, stock, cubiertas, compras y odómetros',
                    'Revisar kilómetros, consumo, incidencias, predictivo y movimientos',
                    'Abrir el informe de vida de una cubierta',
                    'Buscar una cubierta por número',
                ],
                'cannot' => [
                    'Montar, rotar, retirar o medir cubiertas',
                    'Registrar compras ni corregir odómetros',
                    'Acoplar unidades, dar de baja ni administrar catálogos',
                    'Consultar telemetría de operación',
                ],
            ],
            [
                'role' => UserRole::Operario,
                'summary' => 'Perfil operativo de playa y taller: registra el trabajo diario sobre tractor y acoplado desde la planilla.',
                'day' => 'Selecciona la unidad, registra el kilometraje, monta o cambia cubiertas e informa pinchadura, rotación, incidencia y medición.',
                'can' => [
                    'Operar la planilla: instalar, cambio, pinchadura, rotación, retiro a stock, incidencia y medición',
                    'Registrar compras en borrador y confirmar el ingreso a stock',
                ...
                'cannot' => [
                    ...
                    'Modificar la configuración de ejes de una unidad',
                    'Dar de baja definitiva o registrar recapado',
                    'Editar catálogos ni usuarios',
                ],
            ],
            [
                'role' => UserRole::Logistica,
                'summary' => 'Opera igual que el operario y, además, arma el conjunto tractor + acoplado y corrige lecturas de kilometraje.',
                ...
                'can' => [
                    ...
                    'Acoplar y desacoplar unidades (el acoplado utiliza el kilometraje del tractor)',
                    'Corregir lecturas de odómetro',
                    'Consultar reportes y movimientos',
                ],
                'cannot' => [
                    'Modificar la configuración de la unidad (6X4, 3E, etc.)',
                    'Dar de baja definitiva ni registrar recapado',
                    'Administrar catálogos ni usuarios',
                ],
            ],
            [
                'role' => UserRole::JefeSector,
                'summary' => 'Responsable del sector: autoriza bajas, recapados y cambios de configuración.',
            ...
            [
                ...
                'summary' => 'Responsable de la parametrización: catálogos, usuarios y corrección de datos maestros.',
                'day' => 'Mantiene marcas, medidas, flotas, bases, proveedores y usuarios. También puede operar la flota cuando sea necesario.',
                'can' => [
                    'Todas las operaciones del jefe de sector',
                    'Administrar marcas, modelos, medidas, flotas, bases, proveedores, tipos y motivos',
                    'Alta, edición y desactivación de usuarios',
                    'Editar unidades, cubiertas y compras; desactivar registros con historial',
                ],
                'cannot' => [
                    'Eliminar un registro que ya tiene historial (se desactiva, no se elimina)',
