...
const styles = StyleSheet.create({
  ...
  // Gap chico a propósito: ícono y texto tienen que leerse como una sola
  // unidad — el aire del botón lo da paddingHorizontal, no este gap.
  btnInner: { flexDirection: 'row', alignItems: 'center', gap: space.xs },
  btnText: { fontSize: type.button, fontWeight: '700' },
  field: { marginBottom: space.sm },
  fieldLabel: { color: colors.muted, marginBottom: space.xs, fontSize: type.label, fontWeight: '600' },
  input: {
  ...
  statVal: { fontSize: type.display, color: colors.ink, fontWeight: '800', marginTop: space.xs },
  chip: {
    minHeight: touchTarget.min,
    paddingHorizontal: space.md,
    justifyContent: 'center',
