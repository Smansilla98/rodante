...
Campo (`/campo`, menú **Buscar cubierta**) y la ficha de baja están pensados para celular y tablet: inputs de 16 px, botones de 44 px y cámara (`capture`) al adjuntar fotos de baja. El informe de vida se puede leer en pantalla angosta e imprimir a A4.
